...
class Motorneurons(object):
    ...
    def __init__(self, name, muscles=None, antagonists=None, agonists=None, anchor_x=0.0, anchor_y=0.0, color=['k', 'm', 'm']):
...
class PatternFormation(object):
    ...
    def add_connections(self):
        ...
        self.pf_net.add_edge(self.name+'_Inp_F_Sw',
                             self.name+'_PF_Sw',
                             weight=-3.)
        self.pf_net.add_edge(self.name+'_Inp_E_St',
                             self.name+'_PF_St',
                             weight=-3.)
        return
